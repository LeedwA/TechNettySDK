...
public final class Message {
  ...
  public  static final class Head extends
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof Message.Head)) {
        return super.equals(obj);
      }
      Message.Head other = (Message.Head) obj;
    ...
    public static Message.Head parseFrom(
    ...
    public static Message.Head parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Message.Head parseFrom(
    ...
    public static Message.Head parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static Message.Head parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Message.Head parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Message.Head prototype) {
    ...
    public static final class Builder extends
      ...
      public Message.Head getDefaultInstanceForType() {
        return Message.Head.getDefaultInstance();
      }

      public Message.Head build() {
        Message.Head result = buildPartial();
      ...
      public Message.Head buildPartial() {
        Message.Head result = new Message.Head(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Message.Head) {
          return mergeFrom((Message.Head)other);
        } else {
      ...
      public Builder mergeFrom(Message.Head other) {
        if (other == Message.Head.getDefaultInstance()) return this;
        if (other.hasFlag()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Message.Head parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Message.Head) e.getUnfinishedMessage();
  ...
  bitField0_ |= 0x00000040;
    ...
    private static final Message.Head DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Message.Head();
    }

    public static Message.Head getDefaultInstance() {
  ...
  public  static final class Base extends
    ...
    public boolean equals(final Object obj) {
      ...
      if (!(obj instanceof Message.Base)) {
        return super.equals(obj);
      }
      Message.Base other = (Message.Base) obj;
    ...
    public static Message.Base parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static Message.Base parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static Message.Base parseFrom(
    ...
    public static Message.Base parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static Message.Base parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static Message.Base parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(Message.Base prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      public Message.Base getDefaultInstanceForType() {
        return Message.Base.getDefaultInstance();
      }

      public Message.Base build() {
        Message.Base result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Message.Base buildPartial() {
        Message.Base result = new Message.Base(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000001) == 0x00000001)) {
          to_bitField0_ |= 0x00000001;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof Message.Base) {
          return mergeFrom((Message.Base)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(Message.Base other) {
        if (other == Message.Base.getDefaultInstance()) return this;
        if (other.hasOpCode()) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        Message.Base parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (Message.Base) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000010;
    ...
    private static final Message.Base DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new Message.Base();
    }

    public static Message.Base getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }
